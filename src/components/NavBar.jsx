  ...
  <header>
     <nav
      ...
      >
       ...
       <div className="hidden w-full md:flex md:items-center md:w-auto h-full" id="menu">
          <ul
            className="pt-4 text-base text-gray-700 md:flex md:justify-between md:pt-0 gap-3"
            >
            <li className=''>
              <Link
            ...
            <li>
              <Link className="md:p-4 py-2 block hover:bg-gradient bg-[#ff6347] rounded-xl text-black " to="/about"
                >Settings</Link>
            </li>
          </ul>
        </div>
