...
const TopBar = ({ timer, start, setClockType }) => {
  ...
  const { pomodorTimer, longBreak, shortBreak, seconds, minutes } = useSelector(
    (state) => state.timer
  );
  ...
  const ButtonStyle =
    "px-0 py-[10px] w-full max-w-[160px] bg-[#ff6347] hover:bg-[#dc5c45] cursor-pointer border-[0.1px] border-black ";
